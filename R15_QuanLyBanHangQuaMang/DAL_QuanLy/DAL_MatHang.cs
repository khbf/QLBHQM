...
namespace DAL_QuanLy
{
    ...
    {
        // class nay có chức năng xử lý trên table MatHang trong SQL
        // Can kế thừa lại class DBConnect để có SQL Connection
        ...
        public DataTable LayDanhSachMatHang()
        {
            try
            {
                SqlDataAdapter ds = new SqlDataAdapter("Select MH.MaMH,MH.TenMH,MH.LoaiMH,NCC.TenNCC,MH.SoLuongTon,MH.SoLuongHangToiThieu,MH.GiaTien"+
                "from MAT_HANG MH, NCC where MH.NCC = NCC.MaNCC", conn);
        ...
        /// <returns></returns>
        /*
        public bool ThemMatHang(DTO_MatHang tv)
        {
            try
            {
                // Ket noi
        ...
        /// <param name="tv"></param>
        /// <returns></returns>
        public bool suaThanhVien(DTO_MatHang tv)
        {
            try
            {
                // Ket noi
